    ...
    <>
      <section className="header">
        <div className="header-container">
          ...
          <div className="right-side">
            ...
            <div className="connect">
              <a href="./assets/pdf/Valuable Coins Project Details.pdf" target="_blank" rel="noreferrer">
                <div className="button animation animated fadeInUp"><h5>Project Details</h5> </div>
              </a>
            </div>

            <div className="connect-mobile">
              <a href="./assets/pdf/Valuable Coins Project Details.pdf" rel="noreferrer">
                <div className="button animation animated fadeInUp"><h5>Project Details</h5> </div>
              </a>
            </div>
      ...
      <section className="hero">
        <div className="hero-container">
          ...
          <div className="left">
            <img className="mobile-visible hero-logo" src="assets/img/hero-logo.svg" alt="hero-logo"/>
            ...
            <div className="button-group">
              <a href="https://pancakeswap.finance/info/token/0xF6e497Bd65DfB7c0556020DD68d007f0AC76bc6a" target="_blank" rel="noreferrer"><div className="buy"> <span>Buy VC Now </span> <span><img src="./assets/img/arror-right.svg" alt="" /></span> </div></a>
              <a href="https://solidity.finance/audits/ValuableCoins/" target="_blank" rel="noreferrer"><div className="buy"> <span>Audit</span> <span><img src="./assets/img/arror-right.svg" alt="" /></span> </div></a>
              <a href="https://t.me/valuablecoins" target="_blank" rel="noreferrer"> <div className="staking">   <span>Join Our Group chat</span>  <span><img src="./assets/img/arror-right.svg" alt="" /></span>   </div></a>
              {/* <a href="https://valuablecointoken.vercel.app/" target="_blank" rel="noreferrer">
                <div className="buy"> 
                  <span>Back Up Site</span> 
                  <span><img src="./assets/img/arror-right.svg" alt="" /></span> 
                </div>
              </a> */}
            </div>
          </div>
          <div className="right"   >
            <img src="assets/img/hero-logo.svg" alt="hero-logo"/>
          </div>
        </div>
      </section>
        ...
        <div className="tokenomics-container">
          ...
          <div className="bottom">
            ...
            <div className="nomics" data-aos="flip-up">
              ...
              <br/>
              <a href="https://bscscan.com/address/0x8BdD8aa79b118BB007208B3496E0Ed53D76d35eF" target="_blank" rel="noreferrer" className="dev-wallet-address">Dev Wallet</a>
            </div>
        ...
        <div className="roadmap-container">
          ...
          <div className="bottom">
            <div className="map" data-aos="fade-up-right" >
              ...
              <div className="roadmap-line"><img src="./assets/img/roadmap-line.png" alt="" /></div>
            </div>

            <div className="map" data-aos="fade-up-left">
              <div className="roadmap-line"><img src="./assets/img/roadmap-line2.png" alt="" /></div>
              <div className="two">
      ...
      <section className="footer">
        <div className="footer-container">
          ...
          <div className="socials">
            <a target="_blank" href="https://twitter.com/valuablecoin1" rel="noreferrer"> <img src="./assets/img/social-icons/twitter.svg" alt="twitter" /></a>
            <a target="_blank" href="https://t.me/valuablecoins" rel="noreferrer">  <img src="./assets/img/social-icons/telegramm.svg" alt="telegram" /></a>
          </div>

          <div className="partners">
            <a target="_blank" href="https://medium.com/@valuablecoin" rel="noreferrer"><div>Medium</div></a>
            <a target="_blank" href="https://bscscan.com/token/0xF6e497Bd65DfB7c0556020DD68d007f0AC76bc6a" rel="noreferrer"><div>BSCSCAN</div></a>
