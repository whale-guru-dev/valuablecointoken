...
export default function Fomo() {
    ...
    }, [vcFomoContractInstance, roundCount])
                ...
                <div className="navigation-container">
                    ...
                    <div className="navigations">
                        ...
                        <a href="/" clas="mobile-hide">
                            <div className="navigations-item active"> <span className="icon-bg"><svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/private-sales.html" clas="mobile-hide">
                            <div className="navigations-item"> <span className="icon-bg active"> <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/staking.html" clas="mobile-hide">
                            <div className="navigations-item"> <span className="icon-bg"> <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#home">
                            <div className="navigations-item "> <span className="icon-bg"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
